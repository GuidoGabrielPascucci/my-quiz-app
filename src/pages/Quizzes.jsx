...
import { Brain, Book, Code, Coins, Music, Gamepad } from "lucide-react"; // Importamos los íconos que usaremos
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {quizzes.map((quiz) => (
          <QuizCard
            ...
            icon={categoryIcons[quiz.category] || Brain} // Usa Brain como ícono por defecto
            difficulty={quiz.difficulty}
            questionsCount={quiz.questionsCount}
            category={quiz.category}
            href={`/quizzes/${quiz.id}`} // Aquí generamos el href dinámicamente
          />
        ))}
